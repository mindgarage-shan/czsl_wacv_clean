...
def configure_model(args, dataset, visualize_attention=False):
    ...
    if args.update_features:
        ...
        image_extractor = get_image_extractor(arch = args.image_extractor, pretrained = True, visualize_attention=visualize_attention)
