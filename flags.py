...
#parser.add_argument('--cv_dir', default="/netscratch/mkhan/zero_shot/logs_cheater/", help='dir to save checkpoints and logs to')
# parser.add_argument('--cv_dir', default="/home/shan/czsl/transform-czsl/logs/", help='dir to save checkpoints and logs to')
parser.add_argument('--cv_dir', default="./logs/", help='dir to save checkpoints and logs to')
#DATA_FOLDER = "/home/shan/czsl/transform-czsl/dataset/datasets/"
...
parser.add_argument('--visualize', default=0, help='GCN Version')
